...
/* ================================= */
			...
			$('#counter').countdown('2015/11/16 12:00:00').on('update.countdown', function(event) {
...
$(document).ready(function() {
	"use strict";
            $('#myContainer').multiscroll({
            	sectionsColor: ['#2B2D35', '#F1E7C0', '#7BAABE', '#2B2D35', '#F1E7C0', '#7BAABE', '#ff3333'],
            	anchors: ['first', 'second', 'third', 'fourth', 'fifth', 'sixth', 'seventh'],
            	menu: '#menu',
            	navigation: true,
            	navigationTooltips: ['Home', 'Problem', 'Solution', 'Online Trading', '', '', ''],
            	loopBottom: true,
            	loopTop: true
            });
